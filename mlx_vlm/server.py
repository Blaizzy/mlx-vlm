...
from .server_app.anthropic import register_routes as register_anthropic_routes
from .server_app.generation import (
    GenerationArguments,
    PromptTooLongError,
    ResponseGenerator,
    ServerMetricsStore,
...
from .server_app.openai import register_routes as register_openai_routes
from .server_app.runtime import runtime
...
_protocol_deps = SimpleNamespace(
    ...
    get_cached_model=lambda *args, **kwargs: globals()["get_cached_model"](
        *args, **kwargs
    ),
    generate=lambda *args, **kwargs: globals()["generate"](*args, **kwargs),
    stream_generate=lambda *args, **kwargs: globals()["stream_generate"](
        *args, **kwargs
    ),
    apply_chat_template=lambda *args, **kwargs: globals()["apply_chat_template"](
        *args, **kwargs
    ),
    infer_tool_parser_from_processor=lambda *args, **kwargs: globals()[
        "_infer_tool_parser_from_processor"
    ](*args, **kwargs),
    load_tool_module=lambda *args, **kwargs: globals()["load_tool_module"](
        *args, **kwargs
    ),
...
def main():
    from .server_app.cli import main as cli_main
