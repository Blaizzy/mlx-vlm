        ...
        **kwargs,
        ...
        if pixel_values_videos is not None:
            ...
            if visual_embeds_multiscale is None:
                ...
                # Positions of the image and video tokens within the joint
                # visual sequence. Each modality's deepstack rows are placed at
                # its own positions, as in the reference implementation.
