...
DeepSeek-OCR-2 is a powerful OCR model based on the SAM + Qwen2 encoder architecture, optimized for document understanding, text extraction, and visual grounding tasks.
...
```
                    ...
                    │                      Dynamic Resolution                          │
                    ├─────────────────────────────────────────────────────────────────┤
Local Patches       │  768×768 → SAM (12×12×896) → Qwen2 (144×896) → Proj (144×1280) │
(1-6 patches)       │                                                                  │
                    ├─────────────────────────────────────────────────────────────────┤
Global View         │ 1024×1024 → SAM (16×16×896) → Qwen2 (256×896) → Proj (256×1280)│
(1 image)           │                                                                  │
                    └─────────────────────────────────────────────────────────────────┘
                                                    ↓
...
DeepSeek-OCR-2 uses dynamic resolution to handle images of varying sizes efficiently:
