...
VARIANTS: dict[str, MageFlowVariant] = {
    "mage-flow-base": _variant(
        ...
        steps=30,
        guidance=5.0,
        aliases=("microsoft/Mage-Flow-Base", "mage-flow-4b-base"),
    ),
    "mage-flow": _variant(
        "mage-flow",
        ...
        steps=20,
        guidance=5.0,
        aliases=("microsoft/Mage-Flow", "mage-flow-4b"),
    ),
    "mage-flow-turbo": _variant(
        ...
        steps=4,
        guidance=1.0,
        aliases=("microsoft/Mage-Flow-Turbo", "mage-flow-4b-turbo"),
    ),
    "mage-flow-edit-base": _variant(
        ...
        steps=30,
        guidance=5.0,
        aliases=("microsoft/Mage-Flow-Edit-Base", "mage-flow-edit-4b-base"),
    ),
    "mage-flow-edit": _variant(
        ...
        steps=30,
        guidance=5.0,
        aliases=("microsoft/Mage-Flow-Edit", "mage-flow-edit-4b"),
    ),
