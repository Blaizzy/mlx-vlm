...
class Flux2TimestepGuidanceEmbeddings(nn.Module):
    ...
    def __call__(self, timestep: mx.array, guidance: mx.array | None) -> mx.array:
        timestep = Flux2TimestepGuidanceEmbeddings._timestep_embedding(
            timestep.astype(mx.float32), self.in_channels
        )
        ...
        if (
            ...
            guidance_emb = self.guidance_linear_2(
                nn.silu(self.guidance_linear_1(guidance))
            )
