...
Adapted from Moonshot's Kimi K3 ``encoding_k3.py`` implementation. This module
keeps chat rendering in Python.
Callers that need token IDs should consume ``EncodeSegment`` objects directly:
structural markers may be encoded as special-token IDs, while user/tool text
and attribute values are encoded as ordinary text.
"""
