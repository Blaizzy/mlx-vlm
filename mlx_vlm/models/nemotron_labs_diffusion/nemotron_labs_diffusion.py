...
class Model(nn.Module):
    ...
    def model_path(self, value):
        ...
        self.language_model.model_path = value
    ...
    def get_input_embeddings(
        ...
        **kwargs,
        ...
        if pixel_values is not None:
            raise ValueError("Nemotron Labs Diffusion is a text-only model.")
        if input_ids is None:
            raise ValueError("input_ids are required for Nemotron Labs Diffusion.")
    ...
    def sanitize(self, weights):
        def transform_key(key):
            ...
            if key.startswith("encoder."):
                return f"language_model.model.{key[len('encoder.'):]}"
