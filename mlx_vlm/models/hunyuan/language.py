...
class Attention(nn.Module):
    def __init__(self, kv_proj: bool, args: ModelConfig):
        super().__init__()
...
class DecoderLayer(nn.Module):
    def __init__(self, args: ModelConfig, kv_proj: bool, layer_idx: int = 0):
        super().__init__()
...
class LanguageModel(nn.Module):
    ...
    def __call__(
        ...
        return LanguageModelOutput(logits=self.model.embed_tokens.as_linear(out))
