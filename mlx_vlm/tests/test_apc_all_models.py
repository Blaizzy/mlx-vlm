...
def test_cache_hit_for_each_model_cache_contract(cache_names, monkeypatch):
    ...
    try:
        ...
        assert manager.stats_snapshot()["restored_tokens"] == expected, cache_names
