...
def _build_gen_args(
    ...
    args = GenerationArguments(
        ...
        dry_multiplier=getattr(request, "dry_multiplier", 0.0),
        dry_base=getattr(request, "dry_base", 1.75),
        dry_allowed_length=getattr(request, "dry_allowed_length", 2),
        dry_sequence_breakers=getattr(request, "dry_sequence_breakers", None),
        dry_range=getattr(request, "dry_range", 0),
