...
- Run the focused parser cases and shared streaming tests from the repository root: `uv run --with pytest python -m pytest mlx_vlm/tests/test_server.py -q -k 'ToolCall or tool_stream'`. Include existing tests for any reused parser that changed.
